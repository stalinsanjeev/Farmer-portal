...
?><br><br>
			...
			<form method="post" action="http://localhost/hack1/farmer-delb.php"> 

	 <input type="text" class="form-input" name="delig" id="email" placeholder="Please Enter id you want to delete"/>
