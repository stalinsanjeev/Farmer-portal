...
<form method="POST" action="http://localhost/hack1/itemscus1.php">
  <div  class="container">
  <img src="rice.jpg" >
  <button class="btn" name="rice">rice</button>
</div></form>
<form method="POST" action="http://localhost/hack1/itemscus1.php">
<div  class="container"  >
  <img src="onion.jpg" >
  <button class="btn" name="onion">onion</button>
</div></form>
<form method="POST" action="http://localhost/hack1/itemscus1.php">
<div  class="container"  >
  <img src="tomato.jpg" >
  <button class="btn" name="tomato">Tomato</button>
</div></form>
</div>
