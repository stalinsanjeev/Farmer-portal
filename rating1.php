...
$name9 = $_POST['request0']; 
$name = $_POST['request'];
$name1 = $_POST['request1'];
$name2 = $_POST['request2'];


 $nodelup=$name2+1;
 $final=($name+$name2)/$nodelup;



	$query = "UPDATE rating1 SET rating='$final',nodel='$nodelup' WHERE username='$name9'";
	...
	$query1 = "SELECT * FROM rating1 ";
	
  	
	$result2=mysqli_query($db, $query1)or die("Error: " . mysqli_error($db));
